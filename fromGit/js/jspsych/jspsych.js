  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><p>Le test se lancera en mode plein écran lorsque vous cliquerez sur le bouton ci-dessous</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Lancer le test</button></div>');
