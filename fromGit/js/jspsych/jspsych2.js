window.jsPsych = (function() {
  ...
  core.init = function(options) {   // *** Démarrage de ANT qui a été totalement paramétré auparavant ***
    function init() {
  ...
  core.totalTime = function() {
    ...
    return performance.now() - exp_start_time.getTime();
  };
  ...
  function evaluateFunctionParameters(trial){
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      if(keys[i] !== 'type'){
        ...
        // console.log("plugins : ", jsPsych.plugins[trial.type].info); // Ajoutée pour débugger...
...
jsPsych.pluginAPI = (function() {
  ...
  var keylookup = {
    'backspace': 8,
    'tab': 9,
    'Enter': 13, // changé enter en Enter
    'shift': 16,
    'ctrl': 17,
    'alt': 18,
    'pause': 19,
    ...
    'end': 35,
    'home': 36,
    'ArrowLeft': 37, // changé leftarrow en ArrowLeft
    'uparrow': 38,
    'ArrowRight': 39, // changé rightarrow en ArrowRight
    'downarrow': 40,
    'insert': 45,
    'delete': 46,
    '0': 48,
